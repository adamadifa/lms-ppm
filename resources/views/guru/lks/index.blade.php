...
@section('content')
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Kelola LKPD</h2>
                <p class="text-gray-600">Manajemen Lembar Kerja Peserta Didik yang Anda buat</p>
            </div>
                    ...
                    <div class="p-4">
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">{{ $l->materi->judul ?? 'Tidak ada materi' }}
                                </p>
                            </div>
                            <div>
            ...
            @empty
                <div class="col-span-full">
                    <div class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Mulai buat LKPD pertama Anda untuk siswa.</p>
                        <div class="mt-6">
                            <a href="{{ route('guru.lks.create') }}"
